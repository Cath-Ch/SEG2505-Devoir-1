 ...
 * stores them as Cartesian coordinates. Polar coordinates are computed
 * on demand, but not stored.
 *
...
public class PointCP3Test
{
  ...
  public static void main(String[] args)
  {
    ...
    System.out.println("\nYou entered:\n" + point);
    System.out.println("\nThe coordinates in polar: (" 
    					+ point.getRho() + ", " + point.getTheta() + ")");
    System.out.println("\nThis design only stores Cartesian coordinates.\n");
    
    PointCP3 point2 = new PointCP3('C', 15, 3);
    System.out.println("\npoint2 in Cartesian: ("
    ...
    PointCP3 rotatedPoint1 = point.rotatePoint(90);

...
/**
 * This class prompts the user for a set of coordinates and tests
 * PointCP5.
 *
...
public class PointCP5Test
{
  ...
  public static void main(String[] args)
  {
    ...
    // If he did, create the PointCP2 or PointCP3 object (referenced using
    // PointCP5) from these arguments.
    ...
    PointCP5 point2 = new PointCP2(15, 3);
    System.out.println("\npoint2: " + point2);
    point2 = point2.convertStorageToCartesian();
    System.out.println("\npoint2 converted to Cartesian: " + point2);
    
    System.out.println("\nDistance between point1 & point2:");
    System.out.println(point.getDistance(point2));
    
    PointCP5 rotatedPoint1 = point.convertStorageToCartesian();
    rotatedPoint1.rotatePoint(90);
    System.out.println("\nRotating point1 by 90 degrees");
    System.out.println("Cartesian: (" + rotatedPoint1.getX() + ", " + rotatedPoint1.getY() + ")");
  }
